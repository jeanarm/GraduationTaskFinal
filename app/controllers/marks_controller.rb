class MarksController < ApplicationController
  ...
  def create
    ...
    @mark = @course.marks.build(mark_params)
   

    respond_to do |format|
      if @mark.save
        format.html { redirect_to course_marks_path, notice: 'Mark was successfully created.' }
  ...
  private
    ...
    def mark_params
      params.require(:mark).permit(:title, :content, :course_id)
    end
end
